...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(yaml
     python
     ;; Begin Added by Kerrick
     outshine
     lsp
     c-c++
     imenu-list
     ;; End Added by Kerrick
     ;; ----------------------------------------------------------------
